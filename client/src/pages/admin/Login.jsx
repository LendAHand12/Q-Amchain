...
export default function AdminLogin() {
  ...
  const verify2FA = async () => {
    try {
      const response = await api.post("/admin/auth/2fa/verify", {
        token: twoFAToken,
        tempToken,
      });
      ...
      <div className="min-h-screen flex items-center justify-center bg-background py-12 px-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={verify2FA} disabled={twoFAToken.length !== 6} className="w-full">
              Verify
            </Button>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background py-12 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Q-Amchain Admin Panel</CardDescription>
        </CardHeader>
        <CardContent>
